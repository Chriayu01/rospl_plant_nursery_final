<?php
    ...
    $con = mysqli_connect("localhost:4306","root"," ", "plantshop");
...
<body>
    ...
    <?php
            ...
            //     while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post"  echo = "plant">
                            
                            <section>

                                    <div class="img">
                                        <img src="product1.jpg" width="500" height="500" >
                                    </div>

                                    <div class="details">
                                        <!-- <span class="new"> NEW </span> -->
                                        <span class="product-name">Top 4 plants for Healthy Homes</span>
                                        ...
                                        <p class="product-description">
                                            This is a set of 4 flowers available
                                        </p>
